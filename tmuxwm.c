 ...
 * Install: doas cp tmuxwm /usr/X11R6/bin/tmuxwm
 */
...
static Bind bind[] = {
        ...
        { XK_4,               Mod1Mask, (Arg) { "tmux", "select-window", "-t", "4",  NULL } },
        { XK_5,               Mod1Mask, (Arg) { "tmux", "select-window", "-t", "5",  NULL } },
        { XK_6,               Mod1Mask, (Arg) { "tmux", "select-window", "-t", "6",  NULL } },
